...
def is_valid_password(password):
    ...
    for character in password:
        # Count each kind of character using str methods
    ...
    # Check if any of the required character counts are zero
    if number_of_lower == 0 or number_of_upper == 0 or number_of_digit == 0:
        return False

    # If special characters are required, check their count
